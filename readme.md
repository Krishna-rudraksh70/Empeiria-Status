...
Tests:<br/>
1. fiboEvenSum(10) should return a number.<br/>
...
2. fiboEvenSum(10) should return 10.<br/>
3. fiboEvenSum(34) should return 44.<br/>
4. fiboEvenSum(60) should return 44.<br/>
5. fiboEvenSum(1000) should return 798.<br/>
6. fiboEvenSum(100000) should return 60696.<br/>
7. fiboEvenSum(4000000) should return 4613732.<br/>
