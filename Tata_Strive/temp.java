...
// public class temp {
// public static void main(String[] args) {
// List<String> possibleNames = Arrays.asList("Alice", "Bob", "Charlie",
// "David", "Eve", "Frank", "Grace", "Hannah", "Ian", "Jack");
...
// // List<? super Num> list2 = new ArrayList<Animal>(); // Valid, List of
// Animal (superclass of Num)
// // List<? super Num> list3 = new ArrayList<Object>(); // Valid, List of
// Object (superclass of all)

// // // List<? super Num> list4 = new ArrayList<Dog>(); // Invalid! Dog is not
// a superclass of Num

// // // This line has an issue
// // List<? extends Num> list5 = new ArrayList<Noon>(); // Valid, but let's
// clarify why
